  ...
  <head>
	...
	<script type="text/javascript">
		$(document).ready(function (e) {
			...
			$.ajax({
			url: "ajaxfile-add-facultym.php", // Url to which the request is send
		...
		$(document).ready(function (e) {
			...
			$('#loading').html('<img src="images/loading.gif" alt="" width="24" height="24">');			
			$.ajax({
			url: "ajaxfile-add-faculty.php", // Url to which the request is send
			type: "POST",             // Type of request to be send, called as method
			data: new FormData(this), // Data sent to server, a set of key/value pairs (i.e. form fields and values)
			contentType: false,       // The content type used when sending data to the server.
			cache: false,             // To unable request pages to be cached
...
?>
 ...
 <form id="uploadimage1" class="form-horizontal" style="display:none">
                 <div class="box-body">				 
                    ...
                    <div class="form-group">
                      <label for="inputPassword3" class="col-sm-2 control-label">Faculty Name</label>
                      <div class="col-sm-6">
                    ...
                    <div class="form-group">
                      <label for="inputPassword3" class="col-sm-2 control-label">Faculty Email</label>
                      <div class="col-sm-6">
                        <input type="text" class="form-control" id="faculty_email" name="faculty_email" placeholder="Faculty Email"/>
                      </div>
                    </div> 					
                   <div class="form-group"> 
				  <label for="inputEmail3" id="status" class="col-sm-2 control-label"></label>
                    <div class="col-sm-6">					
                    <input type="submit" value="Add Faculty" class="btn btn-success" />
...
<br><br><a href="excels/faculty.xlsx" class="btn btn-success btn-sm">Download Faculty Format</a><br>
 <div class="box-body">				 
                    <div class="form-group">
                      <label for="inputPassword3" class="col-sm-2 control-label">Department</label>
                      <div class="col-sm-6">
...
<div class="form-group">
                      <label for="inputEmail3" class="col-sm-2 control-label">Faculty file</label>
                      <div class="col-sm-4">
