  ...
  <head>
	...
	<script>
		$(document).ready(function (e) {
			...
			$.ajax({
			url: "ajaxfile-exam-attendance.php", // Url to which the request is send
          ...
          <!-- Main content -->
            ...
            <div class="box box-default">
              <div class="box-header with-border">
                <h3 class="box-title">Exam Attendance</h3>
              </div>
              <div class="box-body">
...
<form id="uploadimage">		
 ...
 <select class="form-control" name="regulation_id" id="regulation_id">
    		  ...
    		  <select class="form-control" name="years" id="years"  onchange="getSubjects()">
                    ...
                    <div class="form-group col-sm-2">
                     <select class="form-control" name="sems" id="sems"  onchange="getSubjects()">
