  ...
  <head>
	...
	<script type="text/javascript">
		$(document).ready(function (e) {
			...
			$.ajax({
			url: "ajaxfile-add-departments.php", // Url to which the request is send
 ...
 <form id="uploadimage" enctype="multipart/form-data" class="form-horizontal">
                 <div class="box-body">	
                    ...
                    <div class="form-group">
                      <label for="inputPassword3" class="col-sm-2 control-label">Department ID</label>
                      <div class="col-sm-6">
