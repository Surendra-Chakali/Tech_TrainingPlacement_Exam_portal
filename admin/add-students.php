  ...
  <head>
	...
	<script type="text/javascript">
		$(document).ready(function (e) {
			...
			$.ajax({
			url: "ajaxfile-add-studentsm.php", // Url to which the request is send
		...
		$(document).ready(function (e) {
			...
			$('#loading').html('<img src="images/loading.gif" alt="" width="24" height="24">');			
			$.ajax({
			url: "ajaxfile-add-students.php", // Url to which the request is send
			type: "POST",             // Type of request to be send, called as method
			data: new FormData(this), // Data sent to server, a set of key/value pairs (i.e. form fields and values)
			contentType: false,       // The content type used when sending data to the server.
			cache: false,             // To unable request pages to be cached
                 ...
                 <div class="box-body">
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <input type="text" class="form-control" id="enroll_no" name="enroll_no" placeholder="Roll Number"/>						
                      </div>
                    </div> 					
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
						...
						(Enter student name as per SSC Certificate)
                      </div>
                    </div> 					
                   <div class="form-group"> 
...
<a href="excels/students.xlsx" class="btn btn-success btn-sm">Download Students Format</a><br>
 <div class="box-body">
  <div class="form-group">
                      <label for="inputPassword3" class="col-sm-2 control-label">Regulation</label>
                      <div class="col-sm-6">
...
<div class="form-group">
                      <label for="inputEmail3" class="col-sm-2 control-label">Students file</label>
                      <div class="col-sm-4">
