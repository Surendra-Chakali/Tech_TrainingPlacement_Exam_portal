...
{
if (file_exists("uploads/students/" . $original)) {
echo $original . " <span id='invalid'><b>already exists. Rename and upload again</b></span> ";
}
else
{
$sourcePath = $_FILES['file']['tmp_name']; // Storing source path of the file in a variable
$targetPath = "uploads/students/".$original; // Target path where file is to be stored
	...
	{	// Moving Uploaded file
       ...
       // $i=0;		
		...
		{		               
		       $enroll_no=trim($objWorksheet->getCellByColumnAndRow(0, $row)->getValue()," ");			  
			   $student_name=trim($objWorksheet->getCellByColumnAndRow(1, $row)->getValue()," ");
			   //$father_name=trim($objWorksheet->getCellByColumnAndRow(2, $row)->getValue()," ");			   
			       if($stmt->execute())
					{
						mysqli_commit($conn);						
					}
		...
		echo "<b style='color:green'>Students Uploaded Successfully...!!</b><br/>";
